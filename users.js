...
// ✅ IMPORTANTE: Usar EXATAMENTE a mesma secret que no auth-login.js
const JWT_SECRET = process.env.JWT_SECRET || 'expressglass-famalicao-secret-key-ALTERAR-EM-PRODUCAO';
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.error('❌ Erro na gestão de utilizadores:', error.message);
